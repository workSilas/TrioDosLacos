    ...
    <div className="Home">
      ...
      <div className="sessaoDescubra">
        ...
        <div className="colecoesDisplay">
          ...
          <div className="alinharPropiedades">
            ...
            <Link to={'/CatalogoLacosDecorados'} className="botao" onClick={handleClick}>VER</Link>
          </div>
        </div>
        ...
        <div id="trocaDePopriedades" className="colecoesDisplay">
          ...
          <div className="alinharPropiedades">
            ...
            adoráveis</p>
            <Link to={'/CatalogoFaixasDeBebe'} className="botao" onClick={handleClick}>VER</Link>
          </div>
        </div>
        ...
        <div className="colecoesDisplay">
          ...
          <div className="alinharPropiedades">
            <p>Laços com inúmeras estampas,  <br />
            coloridas e leves</p>
            <Link to={'/CatalogoLacosEstampados'} className="botao" onClick={handleClick}>VER</Link>
          </div>
        </div>
        ...
        <div id="trocaDePopriedades" className="colecoesDisplay">
          ...
          <div className="alinharPropiedades">
            ...
            conjuntos de laços</p>
            <Link to={'/CatalogoKitsDeLacos'} className="botao" onClick={handleClick}>VER</Link>
          </div>
        </div>
      </div>
      ...
      <div className="sessaoEncomendas">
        <p>Não encontrou nada que te agrade? <br />
          Faça sua <b style={{ color: "#FFB099" }}>própria configuração! Use da <br />
            sua imaginação para vestir seu bebê.</b>
        </p>
        <Link to={'/Encomendas'} className="botao" onClick={handleClick}>ENCOMENDAR</Link>
      </div>
      ...
      <div className="sessoDeVoltaAoCatalogo">
        <div className="alinharComponentes">
          ...
          <Link to={'/CatalogoLacosDecorados'} className="botao" onClick={handleClick}>CATÁLOGO</Link>
        </div>
